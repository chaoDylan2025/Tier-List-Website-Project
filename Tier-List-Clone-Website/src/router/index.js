...
export const router = createRouter({
  ...
  routes: [
    ...
    },
    {
      ...
      props: {tier_list_name: 'custom_tier_list', tier_list: custom_tier_list.value, show_files_arr: false}
    },
    {
      ...
      component: () => import('../views/CustomizeScreen.vue'),
      props: {tier_list_name: 'default_tier_list', tier_list: default_tier_list.value, show_files_arr: true}
    },
  ],
})
